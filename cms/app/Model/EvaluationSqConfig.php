 ...
 * author: cjj
 */
class Model_EvaluationSqConfig extends Model_Base
{

    const DB_NAME = 'cms';

    const TABLE_NAME = 't_evaluation_sq_config';

    const CHAPTER = 9; //  当前章节ID
    ...
    */
    ...
    public  static  function saveData($aParam)
    {
        ...
        $result = self::getSqConfigByEID($aParam['iEvaluationID']);
        $aParam['iStatus'] = 1;
        //获取开关配置
     ...
     *
    */
    public static function getSqConfigByEID($evaluationID) {

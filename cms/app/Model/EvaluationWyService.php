 ...
 * author: cjj
 */
class Model_EvaluationWyService extends Model_Base
{

    const DB_NAME = 'cms';

    const TABLE_NAME = 't_evaluation_wy_service';

    const CHAPTER = 12; //  当前章节ID
    ...
    public static function saveData($aParam)
    {
        ...
        $result = self::getWyServiceByEID($aParam['iEvaluationID']);
        $aParam['iStatus'] = 1;
        //获取开关配置
     ...
     *
    */
    public static function getWyServiceByEID($evaluationID) {

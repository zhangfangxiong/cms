 ...
 * author: cjj
 */
class Model_EvaluationSqBuilding extends Model_Base
{

    const DB_NAME = 'cms';

    const TABLE_NAME = 't_evaluation_sq_building';

    const CHAPTER = 7; //  当前章节ID
    /*
    * 获取所需配置
    *
    */
    ...
    public  static  function saveData($aParam)
    {
        ...
        $result = self::getSqBuildingByEID($aParam['iEvaluationID']);
        $aParam['iStatus'] = 1;
        //获取开关配置
     ...
     *
    */
    public static function getSqBuildingByEID($evaluationID) {

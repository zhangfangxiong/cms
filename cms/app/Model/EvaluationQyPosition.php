 ...
 * author: cjj
 */
class Model_EvaluationQyPosition extends Model_Base
{

    const DB_NAME = 'cms';

    const TABLE_NAME = 't_evaluation_qy_position';

    const CHAPTER = 16; //  当前章节ID
    /*
    * 获取所需配置
    *
    */
    ...
    public  static  function saveData($aParam)
    {
        ...
        $result = self::getQyPositionByEID($aParam['iEvaluationID']);
        $aParam['iStatus'] = 1;
        //获取开关配置
     ...
     *
    */
    public static function getQyPositionByEID($evaluationID) {

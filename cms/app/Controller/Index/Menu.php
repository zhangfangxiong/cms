...
class Controller_Index_Menu extends Controller_Base
{
    ...
    {
        $aTree = Model_Menu::getTree($this->aCurrProject['id']);
    ...
    public function editAction ()
    {
        if ($this->isPost()) {
            ...
            $aTree = Model_Menu::getMenus($this->aCurrProject['id']);
            $this->assign('aTree', $aTree);
    ...
    public function _checkData ($sType = 'add')
    {
        ...
        if (! Util_Validate::isLength($sMenuName, 3, 20)) {
            return $this->showMsg('菜单图标长度范围为2到20个字！', false);
        }

...
class Controller_Home_Carousel extends Controller_Banner_Base
{


    protected function _getModule()
    {
        return Model_Banner::MODULE_HOME_CAROUSEL_AD;
    }
    ...
    {
        $this->assign('sListUrl', '/Home/Carousel/');
        $this->assign('sOfflineUrl', '/Home/Carousel/offline/');
        $this->assign('sOnlineUrl', '/Home/Carousel/online/');
        $this->assign('sAddUrl', '/Home/Carousel/add/');
        $this->assign('sEditUrl', '/Home/Carousel/edit/');
        $this->assign('sPreviewUrl', '/Home/Carousel/preview/');
    }
